...
public :
	...
	explicit FActionRequest(const NAME_INDEX NewRequestType)
	{
		RequestType = NewRequestType;
	}

	FORCEINLINE const bool IsSameType(const FName OtherRequestType) const { return RequestType == OtherRequestType.GetComparisonIndex(); }
};
